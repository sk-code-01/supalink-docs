...
Before publishing, the agent will ask you to choose:

- **With an API key** — your site is **permanent**. It stays live until you delete it.
- **Without an API key** — your site is **temporary**. It expires in 24 hours automatically.

If you just need a quick preview link, skip authentication. If you want a site that sticks around, authenticate first.

### Step 3: Authenticate (for permanent sites)
