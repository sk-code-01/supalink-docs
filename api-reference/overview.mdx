...
| Method | Endpoint | Description |
|--------|----------|-------------|
| `GET` | `/api/v1/domains` | [List all domains](/api-reference/domains#list-domains) |
| `POST` | `/api/v1/domains` | [Add a domain](/api-reference/domains#add-a-domain) |
| `POST` | `/api/v1/domains/:domain/verify` | [Verify DNS records](/api-reference/domains#verify-a-domain) |
| `DELETE` | `/api/v1/domains/:domain` | [Remove a domain](/api-reference/domains#delete-a-domain) |
